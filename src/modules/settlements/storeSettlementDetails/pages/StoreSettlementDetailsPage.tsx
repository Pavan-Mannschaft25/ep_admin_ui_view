...
import { FiArrowLeft, FiCalendar, FiPackage, FiFilter } from "react-icons/fi";
import { FaIndianRupeeSign } from "react-icons/fa6";
import Pagination from "../../../../components/common/Pagination";
import POPSTabs from "../../../../components/common/POPSTabs";
          ...
          <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-purple-500 transform transition-all duration-200 hover:shadow-lg hover:-translate-y-1">
            <div className="flex items-center justify-between">
              ...
              <div className="bg-purple-100 p-3 rounded-full">
                <FaIndianRupeeSign className="text-purple-600 text-xl" />
              </div>
            </div>
          </div>
