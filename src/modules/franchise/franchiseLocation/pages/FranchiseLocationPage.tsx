...
//   const managerFilter = searchParams.get("manager") || ""; // Get manager from URL params
//   const [searchTerm, setSearchTerm] = useState(managerFilter); // Initialize with manager filter
...
//   // useEffect(() => {
//   //   if (status === "idle" && locations.length === 0) {
...
//       dispatch(fetchFranchiseLocations());
//     }
//   }, [status, dispatch, locations.length]);

//   // Update search term when manager filter changes
//   useEffect(() => {
//     if (managerFilter) {
//       setSearchTerm(managerFilter);
//     }
//   }, [managerFilter]);
...
//                 <button
//                   onClick={() => navigate("/franchise/franchise-list")}
...
//               </div>
//               <div className="bg-teal-100 p-3 rounded-full">
//                 <FaIndianRupeeSign className="text-teal-600 text-xl" />
//               </div>
//             </div>
//           </div>
//         </div>
