...
//     radius: franchise.radius || 10,
//     percentage: franchise.percentage || 15,
//     status: franchise.status,
//     hours: franchise.hours,
//   });
...
import { useAppDispatch } from "../../../../store/hooks";
import { editFranchise, updateFranchiseAsync } from "../franchiseSlice";
import { Franchise } from "../franchiseSlice";
...
export default function EditFranchiseModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Use the async thunk for updating a franchise
      await dispatch(updateFranchiseAsync(formData)).unwrap();
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto">
        <div className="bg-gradient-to-r from-emerald-600 to-teal-700 text-white flex items-center justify-between p-6 border-b border-gray-200">
          <h3 className="text-lg font-semibold">Edit Franchise</h3>
          <button
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="space-y-6">
            ...
            <div>
              <h4 className="text-md font-medium text-gray-900 mb-3 border-b border-gray-200 pb-1">
                Basic Information
              </h4>
              <div className="space-y-4">
                <div>
