...
interface FranchiseTableProps {
  ...
  onDelete: (franchise: Franchise) => void;
  onUpdateStatus: (franchise: Franchise, status: Franchise["status"]) => void;
  onManagerClick?: (manager: string) => void; // Add this prop
}
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center text-sm text-gray-900">
                      <FiUser className="mr-2 h-4 w-4 text-gray-400" />
                      <button
                        onClick={() => handleManagerClick(franchise.manager)}
                        className="text-green-600 hover:text-green-800 font-semibold hover:underline transition-colors duration-150"
