...
export default function AddProductModal({ onClose }: AddProductModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Create a new ProductPricing object with all required fields
                        ...
                        >
                          ...
                          >
                            <path
                              ...
                              strokeLinejoin="round"
                              strokeWidth={2}
                              d="M19 7l-.867 12.142A2 2 0 0 1-1.732 1H7a2 2 0 0 1-1.732-1L3 13m0 0l4.268 4.268A2 2 0 0 1 1.732 1H17a2 2 0 0 1 1.732-1L21 9"
                            />
                          </svg>
                        </button>
                      </td>
            ...
            >
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth={2}
                  d="M12 4v16m8-8H8m12 0l-4 4m0 0l4 4"
                />
              </svg>
              Add Pricing
            </button>
