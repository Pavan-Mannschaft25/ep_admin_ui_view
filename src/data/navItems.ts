...
export const navItems: NavItem[] = [
...

  {
    ...
    children: [
      ...
      { id: "diet-plans", label: "Diet Plans", path: "/diet/diet-plans" },
      {
        id: "family-profiles",
        label: "Family Profiles",
        path: "/diet/family-profiles",
      },
      { id: "labs", label: "Labs", path: "/diet/labs" },
      { id: "lab-reports", label: "Lab Reports", path: "/diet/lab-reports" },
    ],
  },
  {
    id: "fitness",
    ...
    children: [
      ...
      { id: "master-config", label: "Master Config", path: "/master-config" },
      {
        id: "fitpass-orders",
      ...
      { id: "member-management", label: "Member Management", path: "/members" },
